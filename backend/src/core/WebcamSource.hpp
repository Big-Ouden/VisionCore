 ...
 * 
 * Captures live video from a physical camera device using OpenCV's VideoCapture.
 * Supports both auto-configuration (query device capabilities) and manual
 * configuration (request specific resolution/FPS).
 */
